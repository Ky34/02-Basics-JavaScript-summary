...
// use map to create output massives


// console.log('using map', bill.map(x => calculateTips(x)));
// console.log('using map total', bill.map(x => calculateTips(x) + x));



//МОЁ РЕШЕНИЕ ЗАДАЧИ
const calculateTips = bill => bill < 20 ? bill * 20 / 100 : bill * 15 / 100;
...
// console.log(calculateTips(bill[2]));
console.log(bills);
console.log(tips);
console.log(total);
